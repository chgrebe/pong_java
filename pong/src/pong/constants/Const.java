...
public class Const {
	...
	public static final Integer GUI_DESIRED_FPS = Integer.valueOf(60);
	...
	public static final Double PADDLE_MAX_ACCELERATION = Double.valueOf(0.5);
	public static final Double PADDLE_MAX_SPEED = Double.valueOf(3.5);
