...
public class Const {
	...
	public static final Double BALL_SPEED_INCREASE_ON_PADDLE_COLLISION = Double.valueOf(0.3);
	...
	public static final Double PADDLE_ACCELERATION = Double.valueOf(0.26);
	public static final Double PADDLE_FRICTION = Double.valueOf(0.12);
